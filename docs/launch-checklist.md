...
- [x] Confirm the Netcup mailbox provider and ownership of `support@filius.app`.
...
- [x] Confirm the active Netcup mailbox, 180-day operational retention period, and accepted privacy/contract terms.
