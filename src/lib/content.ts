  ...
  de: {
    ...
    privacy: {
      ...
      sections: [
        ...
        {
          title: "Support",
          body: "Das Kontaktformular übermittelt erforderliche Angaben ohne eigene Datenbank an das Netcup-Supportpostfach. Direkte E-Mail bleibt als Alternative verfügbar; Löschung, Rechtsgrundlage und Missbrauchsschutz sind in der Datenschutzerklärung beschrieben.",
        },
        {
          title: "App",
  ...
  en: {
    ...
    privacy: {
      ...
      sections: [
        ...
        {
          title: "Support",
          body: "The contact form relays necessary details without its own database to the Netcup support mailbox. Direct email remains available; deletion, legal basis, and abuse protection are described in the privacy notice.",
        },
        {
          title: "App",
  ...
  fr: {
    ...
    privacy: {
      ...
      sections: [
        ...
        {
          title: "Assistance",
          body: "Le formulaire transmet les informations nécessaires, sans base de données propre, à la boîte d’assistance Netcup. L’e-mail direct reste disponible ; la suppression, la base juridique et la protection contre les abus sont décrites dans la politique de confidentialité.",
        },
        {
          title: "App",
